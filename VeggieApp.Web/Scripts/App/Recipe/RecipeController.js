(function () {
    ...
    'use strict';
    angular.module('VeggiesApp').controller('recipeController', RecipeController);

    RecipeController.$inject = ['$scope', 'recipeService', '$uibModal'];
    function RecipeController($scope, recipeService, $uibModal) {
        var vm = this;
        vm.$scope = $scope;
        ...
        function _selectAll() {
            vm.recipeService.getAll(onSelectAllSuccess, onError);
